...
- Gosto muito de música! Toco violão e guitarra desde que tinha 15 anos de idade e estou aprendendo piano por conta própria agora.
- Amo filosofia e pretendo fazer uma faculdade por satisfação pessoal em algum momento da minha vida.
...
I am currently a full stack developer, with knowledge on **backend** and **frontend**. I love to work like this because i can see the project as whole and see improvements.
...
[![My Awesome Stats](https://awesome-github-stats.azurewebsites.net/user-stats/nascimento-felipe?cardType=level-alternate&theme=gotham&fontFamily=Oxygen&preferLogin=false&Points.Commits=50&Points.ContributedToNotOwnerRepositories=15)](https://git.io/awesome-stats-card)
